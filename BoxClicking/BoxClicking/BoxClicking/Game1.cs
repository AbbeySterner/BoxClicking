...
namespace BoxClicking
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            {
                currentSquare = new Rectangle(rand.Next(0, this.Window.ClientBounds.Width - 25), rand.Next(0, this.Window.ClientBounds.Height - 25),
                                             25, 25);
            ...
            if((mouse.LeftButton == ButtonState.Pressed) && (currentSquare.Contains(mouse.X, mouse.Y)))
            {
                ...
                if (currentSquare.Width <= 4 && currentSquare.Height <= 4)
                {
                    currentSquare.Width = 4;
                    currentSquare.Height = 4;
                }
            }
